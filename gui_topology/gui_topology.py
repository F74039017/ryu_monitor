...
class GUIServerController(ControllerBase):
    ...
    @route('topology', '/')
    def default_page(self, req, **kwargs):
        # default page is index.html. Reference to webob.DirectoryApp() method
        return self.static_app(req)

    # put all static file in /html folder
    @route('topology', '/static/{filename:.*}')
