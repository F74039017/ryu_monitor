...
(function () {
    ...
    d3.netJsonGraph = function(url, opts) {
        ...
        var el = d3.select(opts.el).style("position", "relative"),
            ...
            processJson = function(graph) { //-- mod: processJson
                /**
                 * Init netJsonGraph
                 */
                ...
                var data = opts.prepareData(graph), //-- proc: nodes and links
                    links = data.links,
                    nodes = data.nodes;
                ...
                var link = panner.selectAll(".link") //-- proc: links
                                 .data(links)
                                 .enter().append("line")
                    ...
                    groups = panner.selectAll(".node") // proc: nodes
                                   .data(nodes)
                                   .enter()
                                   .append("g");
