...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    # def send_set_async(self, datapath):
        ...
        # flow_removed_mask = (ofp.OFPRR_IDLE_TIMEOUT | ofp.OFPRR_HARD_TIMEOUT | ofp.OFPRR_DELETE)
        # req = ofp_parser.OFPSetAsync(datapath, flow_removed_mask=[flow_removed_mask, 0])
